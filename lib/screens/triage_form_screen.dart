            ...
            children: [
              ...
              AnimatedContainer(
                ...
                child: DropdownButtonFormField<int>(
                  ...
                  items: [1, 2, 3, 4, 5].map((level) => DropdownMenuItem(value: level, child: Text('Priority $level'))).toList(),
              ...
              DropdownButtonFormField<String>(
                ...
                items: ['Pending', 'In-Transit'].map((st) => DropdownMenuItem(value: st, child: Text(st))).toList(),
              ...
              ElevatedButton(
                ...
                child: const Text('SUBMIT INTAKE', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              )
            ],
          ),
        ),
